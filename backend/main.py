...
# REMOVED passlib import to prevent crash
...
# Fixed typo: it is aegisdb not aegis_db
...
def verify_password(plain_password: str, hashed_password: str):
    ...
    # Check if hash is already bytes, if not convert it
...
def create_certificate(db_name, table_name, record_id, original_data, columns_cleaned, timestamp, salt, admin_user):
    try:
        ...
        pdf.cell(190, 5, txt="Generated by Aegis Sovereignty Engine v2.8 (IAM Enabled)", ln=1, align='C')
        ...
        pdf.multi_cell(190, 6, txt="This document certifies that PII has been irreversibly pseudonymized using Salted Hashing.")
