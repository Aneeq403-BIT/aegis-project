...
# --- DATABASE CONFIG ---
PII_KEYWORDS = ['name', 'social', 'phone', 'mobile', 'addr', 'city', 'zip', 'firstname', 'lastname']
...
def create_certificate(db_name, table_name, record_id, original_data, columns_cleaned, timestamp, salt, admin_user):
    try:
        ...
        pdf.cell(190, 5, txt="Generated by Aegis Sovereignty Engine v2.9 (Polymorphic)", ln=1, align='C')
    ...
    try:
        ...
        try:
            ...
            for r in rows:
                ...
                # 3. PARTIAL MASKING (New)
                elif 'card' in col or 'ssn' in col or 'phone' in col:
                    strategy = "MASK"
                    reason = "Sensitive ID/Phone"

                # 4. FULL HASH (Generic PII)
